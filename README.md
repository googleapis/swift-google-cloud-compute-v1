...
```bash
swift package add-dependency https://github.com/googleapis/swift-google-cloud-compute-v1.git --from 0.3.0
```
...
```swift
.package(url: "https://github.com/googleapis/swift-google-cloud-compute-v1.git", from: "0.3.0", traits: [".defaults", "<TraitName>"])
```
