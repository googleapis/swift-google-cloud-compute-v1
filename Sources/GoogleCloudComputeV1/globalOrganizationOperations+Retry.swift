...
// limitations under the License.
  ...
  extension Clients {
    final class GlobalOrganizationOperationsRetry: GlobalOrganizationOperationsStub {
      let inner: any GlobalOrganizationOperationsStub
      let options: GoogleCloudGax.ClientOptions

      public init(
        _ inner: any GlobalOrganizationOperationsStub, options: GoogleCloudGax.ClientOptions
      ) {
        self.inner = inner
      ...
      public func delete(
        ...
        try await self._intercept(
          ...
          action: {
            (
              r: Clients.GlobalOrganizationOperationsClient.DeleteRequest,
      ...
      public func `get`(
        ...
        try await self._intercept(
          ...
          action: {
            (
              r: Clients.GlobalOrganizationOperationsClient.GetRequest,
              o: GoogleCloudGax.RequestOptions
            ) async throws -> GoogleCloudComputeV1.Operation
            in
      ...
      public func list(
        ...
        try await self._intercept(
          ...
          action: {
            (
              r: Clients.GlobalOrganizationOperationsClient.ListRequest,
              o: GoogleCloudGax.RequestOptions
            ) async throws -> GoogleCloudComputeV1.OperationList
            in
