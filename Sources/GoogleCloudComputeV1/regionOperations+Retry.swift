...
// limitations under the License.
  ...
  extension Clients {
    final class RegionOperationsRetry: RegionOperationsStub {
      let inner: any RegionOperationsStub
      let options: GoogleCloudGax.ClientOptions

      public init(_ inner: any RegionOperationsStub, options: GoogleCloudGax.ClientOptions) {
        self.inner = inner
      ...
      public func delete(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: Clients.RegionOperationsClient.DeleteRequest, o: GoogleCloudGax.RequestOptions)
      ...
      public func `get`(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: Clients.RegionOperationsClient.GetRequest, o: GoogleCloudGax.RequestOptions)
              async throws -> GoogleCloudComputeV1.Operation
            in
      ...
      public func list(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: Clients.RegionOperationsClient.ListRequest, o: GoogleCloudGax.RequestOptions)
              async throws -> GoogleCloudComputeV1.OperationList
            in
      ...
      public func wait(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: Clients.RegionOperationsClient.WaitRequest, o: GoogleCloudGax.RequestOptions)
              async throws -> GoogleCloudComputeV1.Operation
            in
