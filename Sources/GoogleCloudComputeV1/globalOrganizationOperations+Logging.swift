...
// limitations under the License.
  ...
  extension Clients {
    final class GlobalOrganizationOperationsLogging: GlobalOrganizationOperationsStub {
      let inner: any GlobalOrganizationOperationsStub
      let logger: Logging.Logger

      public init(_ inner: any GlobalOrganizationOperationsStub, logger: Logging.Logger) {
        var logger = logger
