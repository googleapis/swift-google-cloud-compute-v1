...
// limitations under the License.
  ...
  extension Clients {
    final class TargetVpnGatewaysRetry: TargetVpnGatewaysStub {
      ...
      public init(_ inner: any TargetVpnGatewaysStub, options: GoogleGax.ClientOptions) {
        self.inner = inner
      ...
      public func aggregatedList(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: TargetVpnGatewaysClient.AggregatedListRequest, o: GoogleGax.RequestOptions)
              async throws -> GoogleCloudComputeV1.TargetVpnGatewayAggregatedList
            in
      ...
      public func delete(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: TargetVpnGatewaysClient.DeleteRequest, o: GoogleGax.RequestOptions) async throws
      ...
      public func `get`(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: TargetVpnGatewaysClient.GetRequest, o: GoogleGax.RequestOptions) async throws
      ...
      public func insert(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: TargetVpnGatewaysClient.InsertRequest, o: GoogleGax.RequestOptions) async throws
              -> GoogleCloudComputeV1.Operation
            in
      ...
      public func list(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: TargetVpnGatewaysClient.ListRequest, o: GoogleGax.RequestOptions) async throws
      ...
      public func setLabels(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: TargetVpnGatewaysClient.SetLabelsRequest, o: GoogleGax.RequestOptions) async throws
              -> GoogleCloudComputeV1.Operation
            in
