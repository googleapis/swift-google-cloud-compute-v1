...
// limitations under the License.
  ...
  extension Clients {
    final class InterconnectLocationsLogging: InterconnectLocationsStub {
      let inner: any InterconnectLocationsStub
      let logger: Logging.Logger

      public init(_ inner: any InterconnectLocationsStub, logger: Logging.Logger) {
        var logger = logger
      ...
      public func `get`(
        ...
        try await self._intercept(
          ...
          name: "`get`",
          action: {
            (r: Clients.InterconnectLocationsClient.GetRequest, o: GoogleCloudGax.RequestOptions)
              async throws -> GoogleCloudComputeV1.InterconnectLocation
            in
      ...
      public func list(
        ...
        try await self._intercept(
          ...
          name: "list",
          action: {
            (r: Clients.InterconnectLocationsClient.ListRequest, o: GoogleCloudGax.RequestOptions)
              async throws -> GoogleCloudComputeV1.InterconnectLocationList
            in
