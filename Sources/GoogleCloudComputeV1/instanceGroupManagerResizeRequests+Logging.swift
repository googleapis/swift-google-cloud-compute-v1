...
// limitations under the License.
  ...
  extension Clients {
    final class InstanceGroupManagerResizeRequestsLogging: InstanceGroupManagerResizeRequestsStub {
      let inner: any InstanceGroupManagerResizeRequestsStub
      let logger: Logging.Logger

      public init(_ inner: any InstanceGroupManagerResizeRequestsStub, logger: Logging.Logger) {
        var logger = logger
