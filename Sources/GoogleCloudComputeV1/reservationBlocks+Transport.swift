          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            guard
              let pathVariable2 = GoogleCloudGax._RoutingMatcher.value(
                request.reservation as Swift.String?, matching: [.singleWildcard])
            else {
              return nil
            }
            guard
              let pathVariable3 = GoogleCloudGax._RoutingMatcher.value(
                request.reservationBlock as Swift.String?, matching: [.singleWildcard])
            else {
              return nil
            }
            let path =
      ...
      public func getIamPolicy(
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            guard
              let pathVariable2 = GoogleCloudGax._RoutingMatcher.value(
                request.parentResource as Swift.String?, matching: [.singleWildcard])
            else {
              return nil
            }
            guard
