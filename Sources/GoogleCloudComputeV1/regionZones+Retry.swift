...
// limitations under the License.
  ...
  extension Clients {
    final class RegionZonesRetry: RegionZonesStub {
      let inner: any RegionZonesStub
      let options: GoogleGax.ClientOptions

      public init(_ inner: any RegionZonesStub, options: GoogleGax.ClientOptions) {
        self.inner = inner
      ...
      public func list(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: RegionZonesClient.ListRequest, o: GoogleGax.RequestOptions) async throws
