...
// limitations under the License.
  ...
  extension Clients {
    final class ImageFamilyViewsRetry: ImageFamilyViewsStub {
      let inner: any ImageFamilyViewsStub
      let options: GoogleGax.ClientOptions

      public init(_ inner: any ImageFamilyViewsStub, options: GoogleGax.ClientOptions) {
        self.inner = inner
      ...
      public func `get`(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: ImageFamilyViewsClient.GetRequest, o: GoogleGax.RequestOptions) async throws
