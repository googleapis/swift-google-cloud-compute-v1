...
// limitations under the License.
  ...
  extension Clients {
    final class InterconnectRemoteLocationsLogging: InterconnectRemoteLocationsStub {
      let inner: any InterconnectRemoteLocationsStub
      let logger: Logging.Logger

      public init(_ inner: any InterconnectRemoteLocationsStub, logger: Logging.Logger) {
        var logger = logger
