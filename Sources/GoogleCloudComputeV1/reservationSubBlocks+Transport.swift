          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            guard
              let pathVariable2 = GoogleCloudGax._RoutingMatcher.value(
                request.parentName as Swift.String?, matching: [.multiWildcard])
            else {
              return nil
            }
            guard
              let pathVariable3 = GoogleCloudGax._RoutingMatcher.value(
                request.reservationSubBlock as Swift.String?, matching: [.singleWildcard])
            else {
              return nil
            }
            let path =
      ...
      public func getIamPolicy(
        ...
        let (path, query, configure) = try {
          ...
          if let candidate = try { () throws -> (Swift.String, [URLQueryItem])? in
            ...
            guard
              let pathVariable2 = GoogleCloudGax._RoutingMatcher.value(
                request.parentResource as Swift.String?, matching: [.multiWildcard])
            else {
              return nil
            }
            guard
