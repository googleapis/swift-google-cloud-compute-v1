...
// limitations under the License.
  ...
  public struct ServerBinding: Codable, Equatable, GoogleCloudWkt._AnyPackable,
    Sendable
  {
    ...
    public enum Type_: Codable, Equatable, Sendable {
      ...
      public var intValue: Int? {
        switch self {
        case .restartNodeOnAnyServer: return 0
        case .restartNodeOnMinimalServers: return 1
        case .serverBindingTypeUnspecified: return 2
      ...
      public init(intValue: Int) {
        switch intValue {
        case 0: self = .restartNodeOnAnyServer
        case 1: self = .restartNodeOnMinimalServers
        case 2: self = .serverBindingTypeUnspecified
