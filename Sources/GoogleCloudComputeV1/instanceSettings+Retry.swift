...
// limitations under the License.
  ...
  extension Clients {
    final class InstanceSettingsRetry: InstanceSettingsStub {
      ...
      public init(_ inner: any InstanceSettingsStub, options: GoogleGax.ClientOptions) {
        self.inner = inner
      ...
      public func `get`(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: InstanceSettingsClient.GetRequest, o: GoogleGax.RequestOptions) async throws
      ...
      public func patch(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: InstanceSettingsClient.PatchRequest, o: GoogleGax.RequestOptions) async throws
