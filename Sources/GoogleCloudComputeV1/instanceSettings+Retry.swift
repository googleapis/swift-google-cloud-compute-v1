...
// limitations under the License.
  ...
  extension Clients {
    final class InstanceSettingsRetry: InstanceSettingsStub {
      let inner: any InstanceSettingsStub
      let options: GoogleCloudGax.ClientOptions

      public init(_ inner: any InstanceSettingsStub, options: GoogleCloudGax.ClientOptions) {
        self.inner = inner
      ...
      public func `get`(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: InstanceSettingsClient.GetRequest, o: GoogleCloudGax.RequestOptions) async throws
      ...
      public func patch(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: InstanceSettingsClient.PatchRequest, o: GoogleCloudGax.RequestOptions) async throws
