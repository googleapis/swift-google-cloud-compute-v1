...
// limitations under the License.
  ...
  extension Clients {
    final class InterconnectRemoteLocationsRetry: InterconnectRemoteLocationsStub {
      let inner: any InterconnectRemoteLocationsStub
      let options: GoogleGax.ClientOptions

      public init(_ inner: any InterconnectRemoteLocationsStub, options: GoogleGax.ClientOptions) {
        self.inner = inner
