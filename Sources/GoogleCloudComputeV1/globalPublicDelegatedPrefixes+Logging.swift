...
// limitations under the License.
  ...
  extension Clients {
    final class GlobalPublicDelegatedPrefixesLogging: GlobalPublicDelegatedPrefixesStub {
      let inner: any GlobalPublicDelegatedPrefixesStub
      let logger: Logging.Logger

      public init(_ inner: any GlobalPublicDelegatedPrefixesStub, logger: Logging.Logger) {
        var logger = logger
