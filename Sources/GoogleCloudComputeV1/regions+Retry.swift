...
// limitations under the License.
  ...
  extension Clients {
    final class RegionsRetry: RegionsStub {
      ...
      public init(_ inner: any RegionsStub, options: GoogleGax.ClientOptions) {
        self.inner = inner
      ...
      public func `get`(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: RegionsClient.GetRequest, o: GoogleGax.RequestOptions) async throws
      ...
      public func list(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: RegionsClient.ListRequest, o: GoogleGax.RequestOptions) async throws
