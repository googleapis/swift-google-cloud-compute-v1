...
// limitations under the License.
  ...
  extension Clients {
    final class RegionsRetry: RegionsStub {
      let inner: any RegionsStub
      let options: GoogleCloudGax.ClientOptions

      public init(_ inner: any RegionsStub, options: GoogleCloudGax.ClientOptions) {
        self.inner = inner
      ...
      public func `get`(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: Clients.RegionsClient.GetRequest, o: GoogleCloudGax.RequestOptions) async throws
      ...
      public func list(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: Clients.RegionsClient.ListRequest, o: GoogleCloudGax.RequestOptions) async throws
