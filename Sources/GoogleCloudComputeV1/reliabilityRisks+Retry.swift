...
// limitations under the License.
  ...
  extension Clients {
    final class ReliabilityRisksRetry: ReliabilityRisksStub {
      ...
      public init(_ inner: any ReliabilityRisksStub, options: GoogleGax.ClientOptions) {
        self.inner = inner
      ...
      public func `get`(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: ReliabilityRisksClient.GetRequest, o: GoogleGax.RequestOptions) async throws
      ...
      public func list(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: ReliabilityRisksClient.ListRequest, o: GoogleGax.RequestOptions) async throws
