...
// limitations under the License.
  ...
  public struct AllocationReservationSharingPolicy: Codable, Equatable, GoogleCloudWKT._AnyPackable,
    Sendable
  {
    ...
    public enum ServiceShareType: Codable, Equatable, Sendable {
      ...
      ///
      /// If the value is unknown, this initializes to [`unknownIntValue`](doc:ServiceShareType/unknownIntValue(_:)).
      public init(intValue: Int) {
        switch intValue {
        case 0: self = .allowAll
        case 1: self = .disallowAll
