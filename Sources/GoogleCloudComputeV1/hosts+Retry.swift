...
// limitations under the License.
  ...
  extension Clients {
    final class HostsRetry: HostsStub {
      ...
      public init(_ inner: any HostsStub, options: GoogleGax.ClientOptions) {
        self.inner = inner
      ...
      public func `get`(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: HostsClient.GetRequest, o: GoogleGax.RequestOptions) async throws
      ...
      public func getVersion(
        ...
        try await self._intercept(
          ...
          idempotent: false,
          action: {
            (r: HostsClient.GetVersionRequest, o: GoogleGax.RequestOptions) async throws
      ...
      public func list(
        ...
        try await self._intercept(
          ...
          idempotent: true,
          action: {
            (r: HostsClient.ListRequest, o: GoogleGax.RequestOptions) async throws
